...
namespace GrundrissTester
{
    class Program
    {
        ...
        static void test1()
        {
            Mat input = new Mat("input.png", ImreadModes.GrayScale);
            ...
            List<int[]> linelist = IDU.getlines(SW, reducedcornerlist, 97);
        ...
        {
            Mat input = new Mat("input.png", ImreadModes.GrayScale);
            List<int[]> linelist = IDU.ProcessImage(input, 5, 97);
